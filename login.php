...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT id FROM `UserData` WHERE `username` = '".hash('md5', $myusername)."' and `password` = '".hash('md5', $mypassword)."'";
...
<main class="form-signin">
    <form action ="" method ="post">
        ...
        <h1 class="h3 mb-3 fw-bold text-danger text-uppercase ">PLEASE LOG IN</h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col">
                    <a class="w-100 btn btn-lg btn-danger" href="signUp.php" type="button">Sign in</a>
    ...
    <?php if ($error==="Your Login Name or Password is invalid") {
        ?>
